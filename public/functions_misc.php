...
function cut_to_the_chase($actions,$templateid){
	...
	echo "<form name=\"cuttothechase\" action=\"".$pageid."\" method=\"post\">\n";
...
function form_filter_simple($actions,$templateid){
	...
	echo "<form name=\"select_activity\" action=\"".$pageid."\" method=\"post\">\n";
...
function form_select_table($pageid){
	...
	echo "<form name=\"select_table\" action=\"".$pageid."\" method=\"post\">\n";
...
function form_select_view(){
	...
	echo "<form name=\"select_view\" action=\"".$pageid."\" method=\"post\">\n";
...
function form_assign_dependencies($view){
	...
	echo "<form name=\"assign_dependencies\" action=\"".$pageid."\" method=\"post\">\n";
...
function form_select_link(){
	...
	echo "<form name=\"select_link\" action=\"".$pageid."\" method=\"post\">\n";
...
function insert_error_page($arg){
	...
	echo "<p>Please go <a href=\"".$pageid."\">back</a> and check the ".$arg."</p>\n";
...
function generate_update_form($table,$templateid,$params){
	...
	echo "<form name=\"update-".$table['name']."-record\" action=\"".$pageid."\" method=\"post\">\n";
...
function generate_update_view_form($view,$templateid,$params,$basetable){
	...
	echo "<form name=\"update-".$view['basetables']['a']['name']."-record\" action=\"".$pageid."\" method=\"post\">\n";
...
function get_selected_record($table,$templateid,$data){
	...
	if($data['operation']=="delete"){
		...
		echo "<p>";
		echo "<a href=\"".$pageid."?operation=delete&amp;delete=true".$parameters."\">Yes</a> | <a href=\"".$pageid."?operation=delete&amp;delete=false".$parameters."\">No</a>\n";
		echo "</p>";
...
function get_selected_view_record($view,$templateid){
	...
	if($_GET['operation']=="delete"){
		...
		if($debug['usedelform']){
			echo "<form id=\"delete_confirm\" action=\"".$pageid."\" method=\"post\">\n";
			...
			echo "<a href=\"".$pageid."?operation=delete&amp;delete=true".$parameters."\">Yes</a> | ";
			echo "<a href=\"".$pageid."?operation=delete&amp;delete=false".$parameters."\">No</a>\n";
		}
		echo "</p>";
...
function display_table_rows_with_operations_rationalised($table,$templateid,$skip,$limit){
	...
	for($i=0;$line = mysql_fetch_array($result, MYSQL_NUM);$i++){
		...
		echo "<a href=\"".$pageid."?operation=view".$parameters."\">view</a>";
		echo "</td> ";
		echo "<td>";
		echo "<a href=\"".$pageid."?operation=update".$parameters."\">update</a>";
		echo "&nbsp;";
		echo "</td>";
		echo "<td>";
		echo "&nbsp;";
		echo "<a href=\"".$pageid."?operation=delete".$parameters."\">delete</a>";
		echo "</td>";
			...
			if(($view['name']=="viewdependenciesa")||
				...
				if($blankValue){
					...
					if(isset($view['attributes'][$j]['group'])){
						if(($groupcount==1)){
							echo ">";
							#echo "<a href=\"".$pageid."\" onMouseover=\"showtip(this,event,'Portfolio')\" onMouseout=\"hidetip()\";>\n";
							echo $line[$j];
							#echo "</a>";
						}else if(($groupcount>1)&&($groupcount<$grouplen)){
							echo ".";
							#echo "<a href=\"".$pageid."\" onMouseover=\"showtip(this,event,'Project')\" onMouseout=\"hidetip()\";>\n";
							echo $line[$j];
							#echo "</a>";
						}else if($groupcount==$grouplen){
							echo ".";
							#echo "<a href=\"".$pageid."\" onMouseover=\"showtip(this,event,'Workpackage')\" onMouseout=\"hidetip()\";>\n";
							echo $line[$j];
							$groupcount=0;
							#echo "</a>";
							echo "</td>\n";
...
function skiplimit($templateid,$skip,$limit,$recordcount){
	...
	#echo "<br/>\n";
	echo "<form name=\"skiplimit_".$templateid."_".$skip."_".$limit."\" action=\"".$pageid."\" method=\"post\">\n";
...
function generate_form($table,$templateid,$pageid){
	...
	echo "<form name=\"insert-".$table['name']."-record\" action=\"".$pageid."\" method=\"post\">\n";
...
function assign___($data1,$data2,$linktable){
	...
	echo "<form name=\"form_".$linktable['name']."\" action=\"".$pageid."\" method=\"post\">\n";
...
function assign_dependencies(){
	...
	echo "<table>";
	echo "<tr>\n";	
	echo "<form name=\"assignDependencies\" action=\"".$pageid."\" method=\"post\">\n";
...
function input_form($table,$templateid){
	...
	echo "<form name=\"".$table['name']."\" action=\"".$pageid."\" method=\"post\">\n";
